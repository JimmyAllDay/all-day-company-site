  ...
  function Dashboard() {
    ...
    const handleSubmit = async (e) => {
      ...
      if (checkPexelsString(e.target[2].value) !== true) {
        setUiError(
          'Only images from the Pexels CDN will be displayed. If your image string does not point to a valid Pexels image, a fallback image will be used. Eg  eg: https://images.pexels.com/photos/2916450/pexels-photo-2916450.jpeg'
        );
      }
